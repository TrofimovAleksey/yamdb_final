...
# Priject api_yamdb
# data:
#   python api_yamdb/manage.py check_data --paths static/data/category.csv
# static/data/genre.csv static/data/titles.csv static/data/genre_title.csv
# --tables reviews_category reviews_genre reviews_title reviews_title_genre
# 	python api_yamdb/manage.py check_data --paths static/data/users.csv
# --tables users_user
# 	python api_yamdb/manage.py check_data --paths static/data/review.csv
# static/data/comments.csv --tables reviews_review reviews_comment
